  ...
  public void init () {
    try {
      Twitter.no_avatar = Gdk.cairo_surface_create_from_pixbuf (
                               new Gdk.Pixbuf.from_resource ("/de/lucaswerkmeister/nextbird/data/no_avatar.png"),
                               1,
                               null);
      Twitter.no_banner = new Gdk.Pixbuf.from_resource ("/de/lucaswerkmeister/nextbird/data/no_banner.png");
    } catch (GLib.Error e) {
